...
! function(t) {
    ...
    e.clone = c, e.addLast = l, e.addFirst = d, e.removeLast = p, e.removeFirst = v, e.insert = h, e.removeAt = E, e.replaceAt = _, e.getIn = y, e.set = g, e.setIn = m, e.update = I, e.updateIn = b, e.merge = O, e.mergeDeep = T, e.mergeIn = S, e.omit = w, e.addDefaults = A;
    /*!
     * Timm
     *
    ...
    t.exports = function(t, e, n, v, h, E, _) {
        ...
        if (x && (m = f(x.call(new t))) !== Object.prototype && m.next && (s(m, b, !0), r || "function" == typeof m[l] || a(m, l, p)), O && w && "values" !== w.name && (T = !0, A = function () {
                return w.call(this)
        }), r && !_ || !d && !T && S[l] || a(S, l, A), u[e] = A, u[b] = p, h) if (y = {
            values: O ? A : I("values"),
                    keys: E ? A : I("keys"),
                    entries: R
                }, _)
    ...
    var r = n(19), i = n(145), o = n(49), a = n(47)("IE_PROTO"), u = function () {
    }, c = function () {
            var t, e = n(86)("iframe"),
                r = o.length;
            for (e.style.display = "none", n(148).appendChild(e), e.src = "javascript:", (t = e.contentWindow.document).open(), t.write("<script>document.F=Object<\/script>"), t.close(), c = t.F; r--;) delete c.prototype[o[r]];
            return c()
        };
    ...
    var c = b(n(100)), s = b(n(38)), f = b(n(283)), l = b(n(289)), d = b(n(301)), p = b(n(302)), v = b(n(303)),
        h = b(n(306)), E = b(n(307)), _ = b(n(129)), y = n(2), g = n(77), m = function (t) {
            if (t && t.__esModule) return t;
            var e = {};
            if (null != t)
                for (var n in t) Object.prototype.hasOwnProperty.call(t, n) && (e[n] = t[n]);
    ...
    var O = y.IX2EngineEventTypes, T = O.MOUSE_CLICK, S = O.MOUSE_SECOND_CLICK, w = y.IX2EngineConstants,
        A = w.COLON_DELIMITER,
    ...
    function lt(t) {
        ...
        r && n.dispatch((0, g.rawDataImported)(r)), a.active || (n.dispatch((0, g.sessionInitialized)({
                ...
                r ? function(t) {
                    ...
                    if ((0, f.default)(d)) {
                        (0, v.default)(d, function(t, e) {
                            ...
                            if (Z(p, u.mediaQueryKeys) || n.dispatch((0, g.mediaQueriesDefined)()), a.actionTypeId === P) {
                                    ...
                                    a && t.forEach(function(t, r) {
                                        ...
                                        ! function(t) {
                                            var e = t.store,
                                                ...
                                                _ = {},
                                                y = {},
                                                g = [], I = c.continuousActionGroups, b = c.id;
                                            z(E, a) && (b = K(n, b));
                                            ...
                                            I.forEach(function(t) {
                                                ...
                                                n.forEach(function(t) {
                                                    var n = t.actionTypeId,
                                                        i = t.config.target;
                                                    if (i) {
                                                        var a = i.boundaryMode ? O : null, u = $(i) + A + n;
                                                        if (y[u] = function() {
                                                                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [],
                                                                    e = arguments[1],
                                                                    n = arguments[2],
                            ...
                            }(a.actionTypeId === M || ut(a.actionTypeId)) && gt({
                                store: n,
                                actionListId: v,
                                eventId: f
                            })
        ...
        }(n)), n.dispatch((0, g.sessionStarted)()), function(t) {
            ! function e(n) {
                var r = t.getState(),
                    i = r.ixSession,
                    o = r.ixParameters;
    ...
    function mt(t) {
        ...
        (0, v.default)(n, function(t) {
            if (!t.continuous) {
                var n = t.actionListId,
                    r = t.verbose;
                Tt(t, e), r && e.dispatch((0, g.actionListPlaybackChanged)({
                    actionListId: n,
                    isPlaying: !1
                }))
            }
    ...
    function It(t) {
        ...
        (0, v.default)(u, function(t) {
            ...
            if (t.actionListId === o && t.eventId === n && a) {
                ...
                Tt(t, e), t.verbose && e.dispatch((0, g.actionListPlaybackChanged)({
                    actionListId: o,
                    isPlaying: !1
                }))
            }
    ...
    function bt(t) {
        ...
        u >= y.length && (0, s.default)(v, "config.loop") && (u = 0), 0 === u && _.useFirstGroupAsInitialState && u++;
        var g = (0, s.default)(y, [u, "actionItems"], []);
        if (!g.length) return !1;
        if (!Q(E, p.mediaQueryKey)) return !1;
        var I = p.hasBoundaryNodes && r ? m.getClosestElement(r, R) : null, b = B(g), O = !1;
        return g.forEach(function(t, a) {
            var s = t.config,
                l = t.actionTypeId,
                d = tt(l),
                p = s.target;
            if (p) {
                ...
                j({
                    ...
                    O = !0;
                    var h = b === a && 0 === p, E = H({element: s, actionItem: t}),
                        _ = G({element: s, actionItem: t, elementApi: m}, v);
                    Ot({
                        store: e,
                        element: s,
                        actionItem: t,
    ...
    function Ot(t) {
        ...
        e.dispatch((0, g.instanceAdded)((0, a.default)({
            ...
            t.dispatch((0, g.animationFrameChanged)(Number.POSITIVE_INFINITY, n)), wt(t.getState().ixInstances[e], t)
        }(e, l) : (X({
            store: e,
            select: function(t) {
        ...
        if (Q(S, O.mediaQueryKey) && (r || n || i)) {
            ...
            if (i) {
                if (h) {
                    ...
                    _ && !M && e.dispatch((0, g.actionListPlaybackChanged)({
                        actionListId: v,
                        isPlaying: !1
                    }))
                }
    ...
    n(138), n(165), n(167), n(332), n(333), n(334), t.exports = n(335)
}, function(t, e, n) {
    "use strict";
    var r = n(13);
    ...
    var r = n(5),
        ...
        l = n(50),
        d = n(30),
        p = n(1), v = n(52), h = n(53), E = n(158), _ = n(159), y = n(19), g = n(20), m = n(15), I = n(45), b = n(22),
        O = n(88), T = n(160), S = n(161), w = n(7), A = n(29), R = S.f, x = w.f, L = T.f, N = r.Symbol, C = r.JSON,
        M = C && C.stringify,
        P = p("_hidden"),
        D = p("toPrimitive"),
        ...
        z = function(t, e, n) {
            return t === V && z(X, e, n), y(t), e = I(e, !0), y(n), i(G, e) ? (n.enumerable ? (i(t, P) && t[P][e] && (t[P][e] = !1), n = O(n, {enumerable: b(0, !1)})) : (i(t, P) || x(t, P, b(1, {})), t[P][e] = !0), H(t, e, n)) : x(t, e, n)
        }, K = function (t, e) {
            y(t);
        ...
        Q = function(t) {
            ...
            return !(this === V && i(G, t) && !i(X, t)) && (!(e || !i(this, t) || !i(G, t) || i(this, P) && this[P][t]) || e)
        },
        q = function(t, e) {
        ...
        Z = function(t) {
            for (var e, n = t === V, r = L(n ? X : m(t)), o = [], a = 0; r.length > a;) !i(G, e = r[a++]) || n && !i(V, e) || o.push(G[e]);
            return o
        };
    k || (u((N = function() {
        ...
        var t = d(arguments.length > 0 ? arguments[0] : void 0),
            e = function(n) {
            this === V && e.call(X, n), i(this, P) && i(this[P], t) && (this[P][t] = !1), H(this, t, b(1, n))
            };
        return o && B && H(V, t, {
            configurable: !0,
            set: e
        ...
        return this._k
    }), S.f = q, w.f = z, n(92).f = T.f = $, n(31).f = Q, n(54).f = Z, o && !n(28) && u(V, "propertyIsEnumerable", Q, !0), v.f = function(t) {
        return W(p(t))
    }), a(a.G + a.W + a.F * !k, {
        Symbol: N
    });
    ...
    t.exports = function(t, e, n, E, _, y) {
        var g = c(t), m = c(e), I = g ? p : u(t), b = m ? p : u(e), O = (I = I == d ? v : I) == v,
            T = (b = b == d ? v : b) == v, S = I == b;
        if (S && s(t)) {
            if (!s(e)) return !1;
            g = !0, O = !1
        ...
        switch (u) {
            ...
            case g.STYLE_SIZE:
                var f = a(t, _.WIDTH),
                    ...
                    d = void 0,
                    p = void 0;
                return d = c.widthUnit === _.AUTO ? N.test(f) ? parseFloat(f) : parseFloat(n.width) : (0, s.default)(parseFloat(f), parseFloat(n.width)), p = c.heightUnit === _.AUTO ? N.test(l) ? parseFloat(l) : parseFloat(n.height) : (0, s.default)(parseFloat(l), parseFloat(n.height)), {
                    widthValue: d,
                    heightValue: p
                };
            case g.STYLE_BACKGROUND_COLOR:
        ...
        switch (o) {
            ...
            case g.STYLE_SIZE:
                var f = i.getStyle,
                    ...
                    v = p.widthUnit,
                    h = p.heightUnit,
                    y = r.config, I = y.widthValue, b = y.heightValue;
                if (!m.IS_BROWSER_ENV) return {widthValue: I, heightValue: b};
                if (v === _.AUTO) {
                    var O = f(n, _.WIDTH);
                    l(n, _.WIDTH, ""), I = d(n, "offsetWidth"), l(n, _.WIDTH, O)
                }
                if (h === _.AUTO) {
                    var T = f(n, _.HEIGHT);
                    l(n, _.HEIGHT, ""), b = d(n, "offsetHeight"), l(n, _.HEIGHT, T)
                }
            ...
            case _.RENDER_TRANSFORM:
                return function(t, e, n, r, i) {
                    var o = G.map(function(t) {
                            ...
                            switch (t) {
                                case g.TRANSFORM_MOVE:
                                    return _.TRANSLATE_3D + "(" + o + l + ", " + u + p + ", " + s + h + ")";
                                case g.TRANSFORM_SCALE:
                                    return _.SCALE_3D + "(" + o + l + ", " + u + p + ", " + s + h + ")";
                                case g.TRANSFORM_ROTATE:
                                    return _.ROTATE_X + "(" + o + l + ") " + _.ROTATE_Y + "(" + u + p + ") " + _.ROTATE_Z + "(" + s + h + ")";
                                case g.TRANSFORM_SKEW:
                        ...
                        a = i.setStyle;
                    k(t, m.TRANSFORM_PREFIXED, i), a(t, m.TRANSFORM_PREFIXED, o), u = r, c = n, s = u.actionTypeId, f = c.xValue, l = c.yValue, d = c.zValue, (s === g.TRANSFORM_MOVE && void 0 !== d || s === g.TRANSFORM_SCALE && void 0 !== d || s === g.TRANSFORM_ROTATE && (void 0 !== f || void 0 !== l)) && a(t, m.TRANSFORM_STYLE_PREFIXED, _.PRESERVE_3D);
                    var u, c, s, f, l, d
                }(t, e, n, i, a);
            case _.RENDER_STYLE:
                return function(t, e, n, r, i, o) {
                    ...
                    switch (u) {
                        ...
                        case g.STYLE_BORDER:
                        case g.STYLE_TEXT_COLOR:
                            var y = O[u], m = Math.round(n.rValue), I = Math.round(n.gValue), b = Math.round(n.bValue),
                                T = n.aValue;
                            k(t, y, o), a(t, y, T >= 1 ? "rgb(" + m + "," + I + "," + b + ")" : "rgba(" + m + "," + I + "," + b + "," + T + ")");
                            break;
                        default:
                            var S = c.unit,
                                w = void 0 === S ? "" : S;
                ...
                return function(t, e, n) {
                    ...
                    switch (e.actionTypeId) {
                        case g.GENERAL_DISPLAY:
                            ...
                            return void(i === _.FLEX && m.IS_BROWSER_ENV ? r(t, _.DISPLAY, m.FLEX_PREFIXED) : r(t, _.DISPLAY, i))
                    }
                }(t, i, a);
    ...
    var b = function (t) {
        ...
        O = Object.freeze((r = {}, (0, u.default)(r, g.STYLE_BACKGROUND_COLOR, _.BACKGROUND_COLOR), (0, u.default)(r, g.STYLE_BORDER, _.BORDER_COLOR), (0, u.default)(r, g.STYLE_TEXT_COLOR, _.COLOR), r)),
        T = Object.freeze((i = {}, (0, u.default)(i, m.TRANSFORM_PREFIXED, _.TRANSFORM), (0, u.default)(i, _.BACKGROUND_COLOR, _.BACKGROUND), (0, u.default)(i, _.OPACITY, _.OPACITY), (0, u.default)(i, _.FILTER, _.FILTER), (0, u.default)(i, _.WIDTH, _.WIDTH), (0, u.default)(i, _.HEIGHT, _.HEIGHT), i)),
        S = {},
        w = 1;
    var A = 1;
    var R = function(t, e) {
    ...
    function L(t) {
        ...
        var a = o.getValidDocument,
            ...
            h = e.target;
        if (!h) return [];
        var E = x(h), g = E.id, I = E.objectId, b = E.selector, O = E.selectorGuids, T = E.appliesTo,
            w = E.useEventTarget;
        if (I) return [S[I] || (S[I] = {})];
        if (T === y.PAGE) {
            var A = a(g);
        ...
        var R = (0, d.default)(n, "action.config.affectedElements", {})[g || b] || {}, L = Boolean(R.id || R.selector),
            N = void 0,
            C = void 0,
            M = void 0,
            P = n && u(x(n.target));
        ...
        return null == C || null == M ? [] : m.IS_BROWSER_ENV && i ? c(M).filter(function(t) {
            return i.contains(t)
        }) : N === _.CHILDREN ? c(C, M) : N === _.IMMEDIATE_CHILDREN ? s(c(C)).filter(l(M)) : N === _.SIBLINGS ? f(c(C)).filter(l(M)) : c(M)
    }
    var N = /px/,
        C = function(t, e) {
    ...
    var D = (o = {}, (0, u.default)(o, g.TRANSFORM_MOVE, Object.freeze({
            xValue: 0,
            yValue: 0,
            zValue: 0
            ...
            yValue: 0,
            zValue: 0
        })), (0, u.default)(o, g.TRANSFORM_SKEW, Object.freeze({
            xValue: 0,
            yValue: 0
        })), o),
        j = Object.freeze({
        ...
        if (m.IS_BROWSER_ENV) {
            ...
            if (r) {
                var i = n.getStyle,
                    ...
                    a = i(t, _.WILL_CHANGE);
                if (a) {
                    var u = a.split(_.COMMA_DELIMITER).map(b);
        ...
        if (m.IS_BROWSER_ENV) {
            ...
            if (r) {
                var i = n.getStyle,
                    o = n.setStyle,
                    a = i(t, _.WILL_CHANGE);
                a && -1 !== a.indexOf(r) && o(t, _.WILL_CHANGE, a.split(_.COMMA_DELIMITER).map(b).filter(function (t) {
                    return t !== r
    ...
    n(267), t.exports = n(6).Object.assign
}, function(t, e, n) {
    var r = n(18);
    r(r.S + r.F, "Object", {
        assign: n(268)
        ...
        switch (e.type) {
            ...
            case d:
                for (var m = e.payload, I = m.width, b = m.mediaQueries, O = b.length, T = null, S = 0; S < O; S++) {
                    var w = b[S], A = w.key, R = w.min, x = w.max;
                    if (I >= R && I <= x) {
                        T = A;
                        break
                    }
    ...
    var r = n(2),
        ...
        m = function(t, e) {
            ...
            } else if (I && b) for (var j = (g - O) / T, F = I.config.easing, G = v(F, j), X = 0, V = a.length; X < V; X++) {
                var k = a[X], U = _(s, k, I.config, f, g), B = (_(s, k, b.config, f, g) - U) * G + U;
                        C[k] = B
                    }
            return (0, i.merge)(t, {position: g, current: C})
        }, I = function (t, e) {
            var n = t,
                r = n.active,
                o = n.origin,
            ...
            if (r && o) {
                var I = m - (a + g);
                if (s) {
                    var b = m - a, O = y + g, T = p(Math.min(Math.max(0, b / O), 1));
    ...
    n(82), n(275), t.exports = n(6).Array.from
}, function(t, e, n) {
    "use strict";
    var r = n(84),
        i = n(18),
    ...
    i(i.S + i.F * !n(281)(function(t) {
        ...
        from: function(t) {
            var e, n, i, l, d = o(t),
                ...
                _ = 0,
                y = f(d);
            if (E && (h = r(h, v > 2 ? arguments[2] : void 0, 2)), null == y || p == Array && u(y))
    ...
    var h, E, _, y = p.IX2EngineEventTypes, g = y.MOUSE_CLICK, m = y.MOUSE_SECOND_CLICK, I = y.MOUSE_DOWN,
        b = y.MOUSE_UP, O = y.MOUSE_OVER, T = y.MOUSE_OUT, S = y.DROPDOWN_CLOSE, w = y.DROPDOWN_OPEN,
        A = y.SLIDER_ACTIVE,
        R = y.SLIDER_INACTIVE,
        x = y.TAB_ACTIVE,
        L = y.TAB_INACTIVE,
    ...
    e.default = (r = {}, (0, i.default)(r, A, Et()), (0, i.default)(r, R, _t()), (0, i.default)(r, w, Et()), (0, i.default)(r, S, _t()), (0, i.default)(r, C, Et(!1)), (0, i.default)(r, N, _t(!1)), (0, i.default)(r, x, Et()), (0, i.default)(r, L, _t()), (0, i.default)(r, B, {
            ...
            switch (u) {
                ...
                case K:
                    var A = st(),
                        ...
                        L = A.scrollWidth,
                        N = A.scrollHeight;
                    T = b ? Math.min(R + g, L) / L : Math.min(x + I, N) / N;
                    break;
                case Y:
                default:
                    S = q(o, s);
        ...
        handler: function(t) {
            ...
            var S = q(i, h), w = e.getBoundingClientRect(), A = (g ? I : 0) / 100, R = (y ? O : 0) / 100;
            A = E ? A : 1 - A, R = _ ? R : 1 - R;
    ...
    r.define("forms", t.exports = function(t, e) {
        ...
        function g(e, n) {
            ...
            o.done = a.find("> .w-form-done"), o.fail = a.find("> .w-form-fail"), o.fileUploads = a.find(".w-file-upload"), o.fileUploads.each(function(e) {
                ! function(e, n) {
                    ...
                    var r, i = t(n.fileUploads[e]),
                        ...
                        g = p.attr("data-w-type-error"), b = p.attr("data-w-generic-error");
                    ...
                    function T(t) {
                        ...
                        "string" == typeof r && 0 === r.indexOf("InvalidFileTypeError") ? i = g : "string" == typeof r && 0 === r.indexOf("MaxFileSizeError") && (i = y), p.text(i), f.removeAttr("data-value"), f.val(""), a.toggle(!1), o.toggle(!0), s.toggle(!0), n.fileUploads[e].uploading = !1, A() || m(n)
                    }
            ...
            o.handler = null, o.redirect = r.attr("data-redirect"), _.test(c) ? o.handler = T : c || (i ? o.handler = "function" == typeof hostedSubmitWebflow ? hostedSubmitWebflow : O : y())
        }
...
Webflow.require('ix2').init({
    "events": {
        "e-9": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5cbd60c1fad96c817f9b50d5|2a7ca9e3-2891-f3ba-8670-088ca52e0c02"
            },
            "config": {
                "loop": false,
        ...
        "e-11": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5cbd60c1fad96c817f9b50d5|198f9314-8f6f-fa9a-14d5-f4fe2bd96e4c"
            },
            "config": {
                "loop": false,
                "scrollOffsetValue": null,
        ...
        "e-13": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5cbd60c1fad96c817f9b50d5|7a5a23a1-2aa7-4708-06ea-c09b052007b0"
            },
            "config": {
                "loop": false,
                "scrollOffsetValue": null,
        ...
        "e-15": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5cbd60c1fad96c817f9b50d5|4feb02e8-a238-1d4f-926f-1156191fab1e"
            },
            "config": {
                "loop": false,
                "scrollOffsetValue": null,
        ...
        "e-17": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5cbd60c1fad96c817f9b50d5|c32ea523-7c68-4c91-16d1-fd999c38735f"
            },
            "config": {
                "loop": false,
                "scrollOffsetValue": null,
        ...
        "e-19": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5cbd60c1fad96c817f9b50d5|b575b126-78cd-0e1e-d4e4-35acfb862699"
            },
            "config": {
                "loop": false,
                "scrollOffsetValue": null,
    ...
    "actionLists": {
                ...
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "duration": 500,
                            "target": {
                                "id": "5cbd60c1fad96c817f9b50d5|d2c3fb30-fce0-c8eb-2751-1c71d2680586"
                            },
                            "xValue": 74,
                            "xUnit": "PX",
                            "yUnit": "PX",
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "value": "block",
                        "target": {
                            "selector": ".live-update",
                            "selectorGuids": ["440139ed-4582-fc0e-8d3f-3decb00f44db"]
                        }
                    }
                }]
            }, {
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "selector": ".map",
                            "selectorGuids": ["18fc5b70-ab4e-d138-f539-661a78c9c1d2"]
                        }
                    }
                }]
            }, {
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "value": "none",
                        "target": {
                            "selector": ".plan-your-route",
                            "selectorGuids": ["c228547a-d8cb-494f-2a44-4b86a784679b"]
                        }
                    }
                }]
            }, {
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "id": "5cbd60c1fad96c817f9b50d5|31d9a9f4-8161-8d47-d6f0-3fac5a5dc282"
                        },
                        "rValue": 255,
                        "gValue": 0,
                        "bValue": 0,
                    ...
                    "config": {
                        ...
                        "duration": 0,
                        "target": {
                            "id": "5cbd60c1fad96c817f9b50d5|2dc6771e-f46c-5df5-2f5a-e30541baf1bc"
                        },
                        "rValue": 255,
                        "gValue": 255,
                        "bValue": 255,
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "id": "5cbd60c1fad96c817f9b50d5|6724c52d-3831-4ca1-d7d9-3cfa98b4a501"
                        },
                        "rValue": 255,
                        "gValue": 0,
                        "bValue": 0,
                    ...
                    "config": {
                        ...
                        "duration": 0,
                        "target": {
                            "id": "5cbd60c1fad96c817f9b50d5|198f9314-8f6f-fa9a-14d5-f4fe2bd96e4f"
                        },
                        "rValue": 0,
                        "gValue": 0,
                        "bValue": 0,
                    ...
                    "config": {
                        ...
                        "duration": 0,
                        "target": {
                            "id": "5cbd60c1fad96c817f9b50d5|7a5a23a1-2aa7-4708-06ea-c09b052007b3"
                        },
                        "rValue": 0,
                        "gValue": 0,
                        "bValue": 0,
                    ...
                    "config": {
                        ...
                        "duration": 0,
                        "target": {
                            "id": "5cbd60c1fad96c817f9b50d5|45035c20-7100-cbeb-0ad5-7b4684a51260"
                        },
                        "rValue": 255,
                        "gValue": 255,
                        "bValue": 255,
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["9831d9ec-93d0-9fb2-35a4-e05419b314aa"]
                        }
                    }
                }]
            }, {
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "value": "flex",
                        "target": {
                            "id": "5cbd60c1fad96c817f9b50d5|05d575aa-7bfd-d4fc-0507-399c73f59cd5"
                        }
                    }
                }]
            }, {
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "selector": ".routes",
                            "selectorGuids": ["83e986b2-426c-10ba-78a3-582b9fafcdba"]
                        }
                    }
                }]
            }],
            "createdOn": 1558551353024,
            "useFirstGroupAsInitialState": false
        },
        "a-6": {
            "id": "a-6",
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["9ae11f81-6c80-66ae-6ffa-3fc7cdef9160"]
                        }
                    }
                }]
            }, {
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "selector": ".route-page",
                            "selectorGuids": ["e52e1546-c187-129e-8fa7-1be99de392b9"]
                        }
                    }
                }]
            }, {
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "selector": ".header",
                            "selectorGuids": ["7c4664ec-5c61-7da2-7cb9-e7b2dc2c1802"]
                        }
                    }
                }, {
                    "id": "a-7-n-6",
        ...
        "a-8": {
            ...
            "createdOn": 1558737271822,
            "useFirstGroupAsInitialState": false
        },
        "a-9": {
            "id": "a-9",
            "title": "map scroll animation",
            "continuousParameterGroups": [{
                "id": "a-9-p",
                ...
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "target": {
                                "useEventTarget": "CHILDREN",
                                "selector": ".result-layer",
                                "selectorGuids": ["e788bf62-d058-ce2d-da19-aebcbb64882c"]
                            },
                            "yValue": 0,
                            "xUnit": "PX",
                            "yUnit": "VH",
